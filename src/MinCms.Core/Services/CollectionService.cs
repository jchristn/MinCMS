namespace MinCms.Core.Services
{
    ...
    public class CollectionService : ICollectionService
    {
        ...
        {
            return CollectionTelemetry.MeasureAsync("list_collections", async () =>
            {
        ...
        {
            return CollectionTelemetry.MeasureAsync("get_collection", async () =>
            {
        ...
        {
            return CollectionTelemetry.MeasureAsync("create_collection", async () =>
            {
        ...
        {
            return CollectionTelemetry.MeasureAsync("delete_collection", async () =>
            {
                if (String.IsNullOrEmpty(slug)) throw new ArgumentNullException(nameof(slug));
        ...
        {
            return CollectionTelemetry.MeasureAsync("list_files", async () =>
            {
                if (String.IsNullOrEmpty(slug)) throw new ArgumentNullException(nameof(slug));
        ...
        {
            return CollectionTelemetry.MeasureAsync("upload_file", async () =>
            {
                if (String.IsNullOrEmpty(slug)) throw new ArgumentNullException(nameof(slug));
        ...
        {
            return CollectionTelemetry.MeasureAsync("download_file", async () =>
            {
                if (String.IsNullOrEmpty(slug)) throw new ArgumentNullException(nameof(slug));
                if (String.IsNullOrEmpty(fileName)) throw new ArgumentNullException(nameof(fileName));
        ...
        {
            return CollectionTelemetry.MeasureAsync("delete_file", async () =>
            {
                if (String.IsNullOrEmpty(slug)) throw new ArgumentNullException(nameof(slug));
                if (String.IsNullOrEmpty(fileName)) throw new ArgumentNullException(nameof(fileName));
        ...
        {
            return CollectionTelemetry.MeasureAsync("batch_delete_files", async () =>
            {
                if (String.IsNullOrEmpty(slug)) throw new ArgumentNullException(nameof(slug));
        ...
        {
            return CollectionTelemetry.MeasureAsync("get_file_metadata", async () =>
            {
                if (String.IsNullOrEmpty(slug)) throw new ArgumentNullException(nameof(slug));
                if (String.IsNullOrEmpty(fileName)) throw new ArgumentNullException(nameof(fileName));
